...
<%
    ...
    if (loginMemberForBooking == null) {
        ...
        List<Seat> seats = SeatsDAO.getDAO().selectSeatsList(screenNo);
        System.out.println(loginMemberForBooking.getType());
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<script>
    ...
    /*
     RecommendSeat Solution
     */
    var type = "<%=loginMemberForBooking.getType()%>";
    var count = "<%=seats.size()%>";

    recommend(count, type);

    function recommend(caseA, caseB) {
//        alert(caseA);
//        alert(caseB);
        if (caseA == "64") {
            switch (caseB) {
                case 'a' :
                    $(".C5, .C6, .D5, .D6, .E5, .E6, .F5, .F6").addClass("recommend_seat");
                    break;
                case 'b' :
                    $(".C4, .C5, .D4, .D5, .E4, .E5, .F4, .F5").addClass("recommend_seat");
                    break;
                case 'c' :
                    $(".C3, .C4, .D3, .D4, .E3, .E4, .F3, .F4").addClass("recommend_seat");
                    break;
                case 'd' :
                    $(".C7, .C8, .D7, .D8, .E7, .E8, .F7, .F8").addClass("recommend_seat");
                    break;
                case 'e' :
                    $(".G4, .G5, .H4, .H5").addClass("recommend_seat");
                    break;
                case 'f' :
                    $(".C1, .C2, .D1, .D2, .E1, .E2, .F1, .F2").addClass("recommend_seat");
                    break;
                case 'g' :
                    $(".G7, .G8, .H7, .H8").addClass("recommend_seat");
                    break;
                case 'h' :
                    $(".G3, .G4, .G5, .G6, .H3, .H4, .H5, .H6").addClass("recommend_seat");
                    break;
                case 'I' :
                    $(".G1, .G2, .H1, .H2").addClass("recommend_seat");
                    break;
            }
        } else if (caseA == "72") {
            switch (caseB) {
                case 'a' :
                    $(".C6, .C7, .D6, .D7, .E6, .E7, .F6, .F7").addClass("recommend_seat");
                    break;
                case 'b' :
                    $(".C4, .C5, .C6, .D4, .D5, .D6, .E4, .E5, .E6, .F4, .F5, .F6").addClass("recommend_seat");
                    break;
                case 'c' :
                    $(".C3, .C4, .D3, .D4, .E3, .E4, .F3, .F4").addClass("recommend_seat");
                    break;
                case 'd' :
                    ...
                    break;
                case 'e' :
                    $(".G4, .G5, .G6,.H4, .H5 .H6").addClass("recommend_seat");
                    break;
                case 'f' :
                    $(".C1, .C2, .D1, .D2, .E1, .E2, .F1, .F2").addClass("recommend_seat");
                    break;
                case 'g' :
                    $(".G8, .G9, .H8, .H9").addClass("recommend_seat");
                    break;
                case 'h' :
                    $(".G3, .G4, .G6, .G7, .H3, .H4, .H6, .H7").addClass("recommend_seat");
                    break;
                case 'I' :
                    $(".G1, .G2, .H1, .H2").addClass("recommend_seat");
                    break;
...
//            alert("결제하실 금액 :" + total);
            ...
            alert("예약한 좌석 번호 : " + $.session.get('checkedSeat'));
            alert("지불하실 금액 : " + $.session.get('price'));
        }
    });
